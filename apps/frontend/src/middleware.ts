...
// Note: /feed is NOT protected — it just redirects to the home "Following" tab,
// which shows its own login prompt when signed out.
const PROTECTED = ['/create', '/dashboard', '/settings', '/notifications', '/admin', '/saved'];
